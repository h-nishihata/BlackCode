...
public class Convert2Morse : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        + "                                   "
        + "タマシキ ミヤコ ノ ウチ ニ / ムネ ヲ ナラベ イラカヲ アラソエル / タカキ イヤシ";
        // キヒトノスマイハ / ヨヨ ヲ ヘテ ツキセヌ モノ ナレド / コレ ヲ マコト カ ト タズヌレバ / ムカシ アリシ イエ ハ マレ ナリ / アルイハ コゾ ヤケテ コトシ ツクレリ / アルイ ハ オオイエ ホロビテ コイエ ト ナル
